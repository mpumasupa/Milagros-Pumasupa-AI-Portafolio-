...
| [Polyglot Nebula-Voice Tech in the Multiverse](./Project3-Voice-Tech-in-the-Multiverse) | Polyglot Nebula is an adaptive voice system built for extreme alien environments. It auto-tunes speech for any atmosphere, cancels infrasound, ensures privacy via bone speakers, and reduces first-contact errors by 85%. Collaborative project by our NLP course group. | Python, Librosa, and SpeechRecognition |
| [NewsBot V 2.0](./Project4-NewBot-V2.0) | This project integrates all the concepts learned throughout the course into a sophisticated AI system featuring multilingual analysis, conversational interfaces, and intelligent content generation. The project is currently ongoing and continuously evolving.Collaborative project by our NLP course group. | Python, spaCy, NLTK, Hugging Face Transformers, PyTorch, TensorFlow, Rasa, Flask, FastAPI, Pandas, NumPy, Git, GitHub. |
---
