...
| [Sentiment and Emotion Analysis](./Project2-Sentiment and Emotion Analysis) | The NewsBot Intelligence System is an end-to-end Natural Language Processing (NLP) pipeline that automatically analyzes, classifies, and extracts insights from news articles. Collaborative project by our NLP course group | Python, Scikit-learn, SpaCy, NLTK, Pandas, Matplotlib, and TextBlob' |
