...
## How to Use
1. Download and open 'notebooks\L07_Sentiment_Emotion_Analysis.ipynb' in Google Colab or Jupyter Notebook.
2. Run each cell in order from top to bottom.
3. Review the visualizations and model results for insights.
